...
const MOCK_TALKS_BY_TRACK = {
  ...
  mentoring: [
    ...
    talk("Como se preparar para entrevistas técnicas", "workshop", ["entrevistas", "recrutamento"], ["gabriela-martins"],
    ...
    talk("Saúde mental na tecnologia: limites, burnout e recomeços", "painel", ["saúde-mental", "bem-estar"], ["aline-teixeira", "larissa-nunes"],
